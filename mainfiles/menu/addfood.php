    ...
    <div class="modal fade" id="addfood" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="fooditem.php" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Name</label>
                            <input type="Text" name="name" class="form-control" placeholder="Enter Food Item Name " required>
                        </div>

                        <div class="form-group">
                            <label>Price</label>
                            <input type="text" id="quantity" name="price" class="form-control" placeholder="Enter Price " required>
                        </div>

                        <div class="form-group">
                            <label>Category</label>
                            <input type="Text" name="category" class="form-control" placeholder="Enter Food Item Category" required>
                        </div>

                        <div class="form-group">
                            <label>Description</label>
                            <input type="Text" name="description" class="form-control" placeholder="Write Description Of Food" required>
                        </div>
                        <div class="form-group">
                            <label>Upload Image</label>
                            <input type="file" name="image" id="foodimage" class="form-control" required>
                        </div>
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h2>Add Food Item/<b> Details</b> </h2>
                        </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <th><img src="<?php echo $res['image']; ?>" width="100" height="100"></th>


                                <td>

                                    <a href="../menu/updatefooditem.php?id=<?php echo $res['id']; ?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons" aria-hidden="true">&#xE254;</i></a>

                                    <a href="../query/delete3.php?idth=<?php echo $res['id']; ?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                </td>
                            </tr>
                        <?php
                            $no++;
