...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="" target="blank">Home <span class="sr-only">(current)</span></a>
                </li>
    ...
    <hr>
    <H2 class="text-center py-3 "style="color:white;font-family: 'Kaushan Script', cursive;">Welcome - <?php echo $_SESSION['username'] ?></H2>
            ...
            ?>
                ...
                <div class="col-lg-3 col-md-3 col-12 ">
                    <div class="card bg-light mb-3 " style="max-width: 18rem;">
                        <div class="card-header text-center" style="font-size:20px;">Total Order</div>
                        <div class="card-body">
                            <h2 class="card-title text-center"><?php echo $nums ?></h2>
                        </div>
                    </div>
            ...
            ?>
                <div class="col-lg-3 col-md-3 col-12">
                    <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
                        <div class="card-header text-center" style="font-size:20px;">Total Feedback</div>
                        <div class="card-body">
                            <h2 class="card-title text-center"><?php echo $nums ?></h2>
            ...
            ?>
                <div class="col-lg-3 col-md-3 col-12">
                    <div class="card text-white bg-danger mb-3" style="max-width: 18rem;">
                        <div class="card-header text-center" style="font-size:20px;">Total Customer</div>
                        <div class="card-body">
                            <h2 class="card-title text-center"><?php echo $nums ?></h2>
            ...
            ?>
                <div class="col-lg-3 col-md-3 col-12">
                    <div class="card text-white bg-warning mb-3" style="max-width: 18rem;">
                        <div class="card-header text-center" style="font-size:20px;">Total Fooditem</div>
                        <div class="card-body">
                            <h2 class="card-title text-center"><?php echo $nums ?></h2>
            ...
            <div>
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        ...
                        <a href="./about.html" target="blank">Read more &rarr;</a>
                    </div>
                    <div class="col-md-4  col-sm-6">
                        <h1 style=" font-size: 30px;">Quick link</h1>
                        <div class=" clearfix">
                            <a href="../mainfiles/contact.php"  target="blank" style="color: white;">
                        ...
                        <div class=" clearfix">
                            <a href="../mainfiles/login/signup.php"   target="blank" style="color: white;">
                        ...
                        <div class=" clearfix">
                            <a href="../mainfiles/about.php" target="blank"  style="color: white;">
                        ...
                        <div class="clearfix last">
                            <a href="../mainfiles/login/customerlogin.php" target="blank"  style="color: white;">
                        ...
                        <div class="clearfix last">
                            <a href="../mainfiles/login/adminlogin.php"  target="blank" style="color: white;">
