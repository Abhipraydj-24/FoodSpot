...
<head>
    ...
    <title>FoodSpot | Login page | Customer</title>
...
<body>
    ...
    ?>
        <div class="alert alert-<?php echo $_SESSION['alert']; ?> alert-dismissible fade show" role="alert">
            <strong>Warning !</strong> <?php echo $_SESSION['fname']; ?>
    ...
    <table>
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
            <ul class="container">
                ...
                <li>New to FoodSpot? <a id="fo" href="../login/signup.php">Create account</a></li>
            </ul>
        </form>
    </table>
...
if (isset($_POST['login'])) {
    ...
    $email_ser = " select * from registration where email='$email'";
    $query = mysqli_query($con, $email_ser);
...
?>
            <script>
                location.replace("../menu/menu.php");
               
            </script>
<?php
        } else {
            $_SESSION['fname'] = 'Password Incorrect';
