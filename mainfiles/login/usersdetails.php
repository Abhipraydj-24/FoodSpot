...
<title>FoodSpot | Customer Details</title>
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8"><h2>Registered Customer/<b> Details</b></h2></div>
                ...
                <table id= "mytable" class="table table-striped table-hover table-bordered">
                   ...
                   <td>
                       ...
                       <a href="../query/delete2.php?idth=<?php echo $res['id'];?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons" >&#xE872;</i></a>
                   </td>
               </tr>
               <?php
               $no++;
